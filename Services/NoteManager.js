...
const createUpdatedNote = (title, content, tags, priority) => {
    return { 
        title: title, 
        content: content,
...
const createNewNote = (title, content, tags, priority) => {
    return {
        title: title,
        content: content,
...
class NoteManager {    
    ...
    addNote(title, content, tags, priority) {

        assert(title, 'Title is required');
        assert(content, 'Content is required');
        assert(priority, 'Priority is required');
        
        const note = createNewNote(title, content, tags, priority);
    ...
    updateNote(id, title, content, tags, priority) {
        assert(id, 'Id is required');
        assert(title, 'Title is required');
        assert(content, 'Content is required');
        assert(priority, 'priority is required');
        
        const note = createUpdatedNote(title, content, tags, priority);
